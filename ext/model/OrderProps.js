Ext.define('Plugin.sale.model.OrderProps', {
    ...
    proxy: {
		...
		simpleSortMode: true,
        api: {
            read    : '/plugins/sale/data_order_props.php',
            update  : '/plugins/sale/data_order_props.php?action=update',
            create  : '/plugins/sale/data_order_props.php?action=create',
            destroy : '/plugins/sale/data_order_props.php?action=destroy'			
        },		
        reader: {
			type: 'json',
            root: 'rows'
